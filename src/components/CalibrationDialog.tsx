          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0"><Calendar mode="single" selected={calibrationDate} onSelect={setCalibrationDate} /></PopoverContent>
              </Popover>
            </div>
            <div>
              <Label>Nova Data de Vencimento</Label>
               <Popover>
                ...
                <PopoverContent className="w-auto p-0"><Calendar mode="single" selected={newDueDate} onSelect={setNewDueDate} /></PopoverContent>
              </Popover>
            </div>
          </div>
           <div>
