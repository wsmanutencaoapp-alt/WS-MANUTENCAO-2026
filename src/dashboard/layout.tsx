...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (!isLoading && user && employeeData) {
      ...
      // If no specific permission is required for the path, allow access.
      ...
      // If the user is not an admin and doesn't have the required permission, redirect.
      if (!employeeData.permissions || !employeeData.permissions[requiredPermission]) {
        // Redirect to the main dashboard as a fallback.
