...
import { AlertTriangle, ShieldCheck, Settings, CheckCircle, Loader2, PlusCircle, User, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visualize, adicione e gerencie os funcionários da empresa e seus status de acesso.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
