...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <SidebarProvider>
        ...
        <AppSidebar />
        <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14 transition-[margin-left] ease-in-out duration-300 md:group-[[data-sidebar-state=open]]/sidebar-wrapper:ml-64">
            <Header />
            <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
            {children}
            </main>
