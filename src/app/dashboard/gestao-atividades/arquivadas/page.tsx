...
import { Loader2, Search, Inbox, ArchiveRestore, Eye } from 'lucide-react';
                                ...
                                {!isLoading && filteredActivities.map(activity => (
                                    <TableRow key={activity.docId}>
                                        ...
                                        <TableCell className="text-right space-x-2">
                                            ...
                                            <Button variant="secondary" size="sm" onClick={() => handleUnarchive(activity.docId)} disabled={isProcessing === activity.docId}>
